/**
 * @fileOverview A dynamic page to display details for a specific product category.
 * It fetches category data from Firestore based on the slug from the URL.
 */
"use client";
...
/**
 * Renders the dynamic product category page.
 * @returns {JSX.Element} The category detail page component.
 */
      ...
      <div className="flex flex-col min-h-dvh bg-background">
        ...
        <main className="flex-grow flex items-center justify-center text-center">
          <div>
            ...
            <p className="mt-2 text-muted-foreground">Sorry, we couldn't find the category you're looking for.</p>
